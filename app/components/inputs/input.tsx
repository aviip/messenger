  ...
  return (
    <div>
      ...
      <div className="mt-2">
        ...
        />
        {/* we can use form-input class because of the tailwindcss/forms package */}
        {/* if the error is in id then it will apply this 'focus:ring-rose-500' classname and vice versa */}
      </div>
    </div>
  );
};
